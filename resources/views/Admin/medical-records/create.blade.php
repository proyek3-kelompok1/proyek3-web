...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{ route('admin.queue.index') }}" class="btn btn-sm btn-outline-purple">
            <i class="fas fa-arrow-left me-1"></i>Kembali ke Antrian
        </a>
    </div>
</div>
...
<form action="{{ route('admin.medical-records.store') }}" method="POST" id="medicalRecordForm">
    @csrf
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_pemilik" name="nama_pemilik" 
                               value="{{ old('nama_pemilik', $booking->nama_pemilik) }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_hewan" name="nama_hewan" 
                               value="{{ old('nama_hewan', $booking->nama_hewan) }}" required>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="alamat" name="alamat" 
                               value="{{ old('alamat', $booking->alamat) }}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="jenis_hewan" name="jenis_hewan" 
                               value="{{ old('jenis_hewan', $booking->jenis_hewan) }}" required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="ras" name="ras" 
                               value="{{ old('ras', $booking->ras) }}" required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="umur" name="umur" 
                               value="{{ old('umur', $booking->umur) }}" min="0" required>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="ciri_warna" name="ciri_warna" 
                               value="{{ old('ciri_warna', $booking->ciri_warna) }}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="jenis_kelamin" name="jenis_kelamin">
                            ...
                            <option value="Jantan" {{ old('jenis_kelamin', $booking->jenis_kelamin) == 'Jantan' ? 'selected' : '' }}>Jantan</option>
                            <option value="Betina" {{ old('jenis_kelamin', $booking->jenis_kelamin) == 'Betina' ? 'selected' : '' }}>Betina</option>
                        </select>
                    </div>
                </div>
            </div>
    ...
    <div class="card card-purple mt-4">
        ...
        <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="status" name="status" required>
                            ...
                            @foreach($statuses as $key => $status)
                                <option value="{{ $key }}" {{ old('status', 'selesai') == $key ? 'selected' : '' }}>
                                    {{ $status }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="kunjungan_berikutnya" name="kunjungan_berikutnya" 
                               value="{{ old('kunjungan_berikutnya', '') }}">
                    </div>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="keluhan_utama" name="keluhan_utama" rows="3" required>{{ old('keluhan_utama') }}</textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="prognosa" name="prognosa" rows="3">{{ old('prognosa') }}</textarea>
            </div>

            <div class="mb-3">
                <label for="tindakan" class="form-label fw-bold">Tindakan yang Dilakukan</label>
                <textarea class="form-control" id="tindakan" name="tindakan" rows="3">{{ old('tindakan') }}</textarea>
            </div>

            <div class="mb-3">
                <label for="resep_obat" class="form-label fw-bold">Resep Obat</label>
                <textarea class="form-control" id="resep_obat" name="resep_obat" rows="3">{{ old('resep_obat') }}</textarea>
            </div>

            <div class="mb-3">
                <label for="catatan_dokter" class="form-label fw-bold">Catatan & Saran Dokter</label>
                <textarea class="form-control" id="catatan_dokter" name="catatan_dokter" rows="3">{{ old('catatan_dokter') }}</textarea>
            </div>
        </div>
    </div>
    ...
    <div class="card card-purple mt-4">
        ...
        <div class="card-body">
            <div id="vaccinations-container">
                @foreach(collect([]) as $index => $vaksin)
...
document.addEventListener('DOMContentLoaded', function() {
    let vaccinationCount = {{ collect([])->count() }};
