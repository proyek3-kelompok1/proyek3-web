...
@section('title', 'Edit Layanan - Admin DV Pets')
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{ route('admin.services.show', $service->id) }}" class="btn btn-sm btn-outline-info me-2">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('details') is-invalid @enderror" 
                                  id="details" name="details" rows="5" required>{{ old('details', $service->details) }}</textarea>
                        @error('details')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('icon') is-invalid @enderror" 
                            ...
                            @foreach($icons as $key => $icon)
                                <option value="{{ $key }}" {{ old('icon', $service->icon) == $key ? 'selected' : '' }}>
                        ...
                        <div class="mt-2 text-center">
                            <i id="icon-preview" class="{{ $service->icon }} fa-2x text-purple"></i>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('price') is-invalid @enderror" 
                               id="price" name="price" value="{{ old('price', $service->price) }}" min="0" step="1000">
                        @error('price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('duration_minutes') is-invalid @enderror" 
                               id="duration_minutes" name="duration_minutes" value="{{ old('duration_minutes', $service->duration_minutes) }}" min="0">
            ...
            <div class="card card-purple">
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('admin.services.show', $service->id) }}" class="btn btn-outline-secondary">
