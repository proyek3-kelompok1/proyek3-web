                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <select id="pet_type" name="pet_type" required>
                                    ...
                                    <option value="kelinci" {{ old('pet_type') == 'kelinci' ? 'selected' : '' }}>Kelinci
                                    </option>
                                    <option value="hamster" {{ old('pet_type') == 'hamster' ? 'selected' : '' }}>Hamster
                                    </option>
                                    <option value="lainnya" {{ old('pet_type') == 'lainnya' ? 'selected' : '' }}>Lainnya
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <textarea id="message" name="message"
                                    placeholder="Jelaskan keluhan atau pertanyaan Anda mengenai hewan peliharaan..."
                ...
                <div class="info-container">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-text">
                            ...
                            <p>Rawat inap 24 jam, vaksinasi, konsultasi umum, operasi, pemeriksaan lab, scalling gigi, dan
                                penitipan hewan.</p>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-with-icon">
                                        ...
                                        <textarea id="feedbackMessage" name="message"
                                            placeholder="Bagikan pengalaman Anda menggunakan layanan klinik kami..."
                                            required></textarea>
                                    </div>
                                </div>
